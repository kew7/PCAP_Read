// PCAP_Read.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
#include <string>
#include <iostream>
#include <d:\My Proects\Visual C++\!!! ПРИМЕРЫ\USB\WinDump-0.3\Include\pcap.h>
